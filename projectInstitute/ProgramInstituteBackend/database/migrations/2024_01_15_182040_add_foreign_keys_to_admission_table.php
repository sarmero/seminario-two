...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('admission', function (Blueprint $table) {
            ...
            $table->foreign(['state_id'], 'fk_admission_4')->references(['id'])->on('state')->onUpdate('CASCADE')->onDelete('CASCADE');
            $table->foreign(['offer_id'], 'admission_ibfk_1')->references(['id'])->on('offer')->onUpdate('CASCADE')->onDelete('CASCADE');
        });
    }
