    ...
    <script>
        ...
        function obtain_data_table(response) {
            ...
            $.each(response, function(index, teacher) {
                ...
                name.textContent = teacher.person.first_name;
                last.textContent = teacher.person.last_name;

                opt.innerHTML = `
                <div class="icon">
                    <a href="/admin/teacher/person/ ${teacher.person.id}" title="visualizar" target="_blank"><i class="fas fa-eye"></i></a>
